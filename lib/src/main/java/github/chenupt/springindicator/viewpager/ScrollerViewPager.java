...
public class ScrollerViewPager extends ViewPager {
   ...
   public SwipeDirectoin direction;
   ...
   /* @Override
    ...
    private boolean IsSwipeAllowed(MotionEvent ev) {
        ...
        if(direction == SwipeDirectoin.none ) {//disable any swipe
            return false;
        }
        return true;
    }

    public void setAllowedSwipeDirection1(SwipeDirectoin direction) {
        this.direction = direction;
    }
   public enum SwipeDirectoin
    {
        none;
    }
}
